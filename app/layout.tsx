...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="da" className={`dark h-full ${inter.variable} ${lexend.variable} ${spaceGrotesk.variable}`}>
      <body
        className="bg-[#0A0C10] text-white font-sans antialiased selection:bg-orange-500 selection:text-white min-h-screen relative flex flex-col overflow-x-hidden touch-manipulation"
